...
public class MovieDatabase extends SQLiteOpenHelper implements Serializable {
    ...
    public static final String column1 = "Movie_Title";
    public static final String column2 = "Movie_ID";
    ...
    public boolean dataIsPresent(String fieldValue) {
        ...
        String Query = "Select * from " + TABLE_NAME + " where " + column2 + " = " + fieldValue;
    ...
    public void deleteData(String id) {
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("delete from "+TABLE_NAME+" where " + column2 + " = " + id);
    }
