...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String TAG = "Tagged";
    ...
    String popMoviesURL, topRatedMoviesURL;
    ...
    private void InitRecyclerView(ArrayList<Movie> movieList, boolean favorites)
    {
        ...
        RecyclerViewAdapter recyclerViewAdapter = new RecyclerViewAdapter(this, movieList);
    ...
    public class MovieGetter extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            popMoviesURL = "http://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=27e151a219f0a3a44542390fc3123cbe";

            topRatedMoviesURL = "http://api.themoviedb.org/3/discover/movie?sort_by=vote_average.desc&api_key=27e151a219f0a3a44542390fc3123cbe";

            mPopularList = new ArrayList<>();
            mTopTopRatedList = new ArrayList<>();
            try {
                if(MovieUtils.networkStatus(MainActivity.this)){
                    mPopularList = MovieUtils.fetchData(popMoviesURL); //Get popular movies
                    mTopTopRatedList = MovieUtils.fetchData(topRatedMoviesURL); //Get top rated movies
